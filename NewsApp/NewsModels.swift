...
struct NewsArticle: Identifiable, Hashable {
    ...
    static let sampleArticles: [NewsArticle] = [
        ...
        NewsArticle(
            ...
            imageUrl: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80",
            category: .health,
